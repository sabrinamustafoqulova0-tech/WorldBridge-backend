...
from app.models.program import Program, ProgramCategory, ProgramLevel  # noqa: F401
...
SAMPLE_PROGRAMS = [
    ...
    },
    {
        ...
        "short_description": "Study at a German university — tuition-free in most federal states for international students.",
        "description": (
            "Germany offers world-class bachelor's degrees, mostly tuition-free at public universities. "
            "International applicants need to meet language requirements (German or English programs), "
            "provide school-leaving certificates, and in some cases pass an aptitude test (Aufnahmeprüfung)."
        ),
        "duration_months": 36,
        "min_age": 18,
        "max_age": None,
    ...
    },
    {
        ...
        "short_description": "Move to Germany as a skilled worker under the new Fachkräfteeinwanderungsgesetz.",
        "description": (
            "Germany actively recruits skilled workers (Fachkräfte) from outside the EU. "
            "The Skilled Immigration Act (Fachkräfteeinwanderungsgesetz 2023) makes it easier to have "
            "foreign qualifications recognised and to obtain a work visa. Salaries start around 2 500 €/month."
        ),
    ...
    },
    {
        ...
        "description": (
            ...
            "German culture and language. Programs run from August/September to June."
        ),
        "duration_months": 10,
        "min_age": 14,
        "max_age": 18,
