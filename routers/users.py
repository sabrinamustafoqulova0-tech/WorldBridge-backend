...
from schemas.user import PasswordChange, UserListResponse, UserResponse, UserUpdate
from services.auth_service import AuthService
from utils.dependencies import get_current_active_user, get_current_admin
...
async def list_users(
    ...
    svc = AuthService(db)
    users, total = await svc.list_users(skip=(page - 1) * size, limit=size)
